...
Internally, it uses the Typescript [ldes-client](https://github.com/Maregraph-EU/ldes-client) and the also Typescript [sparql-ingest-processor](https://github.com/Maregraph-EU/sparql-ingest-processor-ts).  
